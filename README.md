# NEPSE-STOCK-CLASSIFIER
PROJECT: NEPSE STOCK CLASSIFIER
BUY SIGNALER
...
2.	Stock where EMA 50 is not created in weekly time frame, candles above EMA 9 is used for BUY signal. (NEW STOCKS)

GENERAL DESCRIPTION OF IDEA:

For instance, to classify stock as BUY, EMA 9 should be above EMA 50 in weekly and daily timeframe. The buying position should be near the EMA 50, while 10-20 points gap can be considered. If stock is way above EMA 50, for buying EMA 9 should be close to candles (close means touching the EMA 9 and moving upward direction). 
